# My modifications
## In onFPSListener and onDetectedInfo in MainActivity.kt, use
```
lifecycleScope.launch(Dispatchers.Main) {
}
```

## In CameraSource.kt, rotateMatrix.postRotate(0f) instead of rotateMatrix.postRotate(90.0f)

## modelPos = 0 in MainActivity.kt
## Download and use "lite-model_movenet_singlepose_lightning_tflite_int8_4.tflite" instead of "movenet_lightning.tflite"

## In CameraSource.kt, try different PREVIEW_WIDTH and PREVIEW_HEIGHT, 640 and 480 respectively are currently the best.
